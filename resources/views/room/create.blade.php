...
<div class="content--title">
    ...
    <div class="col-xl-6">
        ...
        <ul class="content--title--right--breadcrumb">
            ...
            <li class="active"><a href="{{ url('pokoje/dodaj') }}">Dodaj pokój</a></li>
        </ul>
        </div>
    </div>
    </div>
...
<div class="content--main">
    ...
    <div class="col-xl-12">
        ...
        <div class="row">
            ...
            @endif
            <form method="POST" action="{{ url('pokoje/dodaj') }}" >
            @csrf
                <div class="form-group">
                <label for="exampleInputEmail1">Nazwa pokoju</label>
                <input type="text" class="form-control" name="room_name">
                </div>
                <button type="submit" class="btn-md btn-primary">Dodaj pokój</button>
