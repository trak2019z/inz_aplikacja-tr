...
<div class="content--title">
    ...
    <div class="col-xl-6">
        ...
        <h4>Edytyj {{ $schoolroom->schoolroom_name }}</h4>
        </div>
    </div>
    ...
    <div class="col-xl-6">
        ...
        <ul class="content--title--right--breadcrumb">
            ...
            <li class="active"><a href="{{ url('klasy/edytuj/'.$schoolroom->schoolroom_id) }}">Edycja klasy</a></li>
        </ul>
        </div>
    </div>
    </div>
...
<div class="content--main">
    ...
    <div class="col-xl-12">
        ...
        <div class="row">
            ...
            @endif
            <form method="POST" action="{{ url('klasy/edytuj/'.$schoolroom->schoolroom_id) }}" >
            @csrf
                <div class="form-group">
                <label for="exampleInputEmail1">Nazwa klasy</label>
                <input type="text" class="form-control" name="schoolroom_name" value="{{ $schoolroom->schoolroom_name }}">
                </div>
