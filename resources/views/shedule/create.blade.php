...
<div class="content--title">
    ...
    <div class="col-xl-6">
        ...
        <ul class="content--title--right--breadcrumb">
            ...
            <li class="active"><a href="{{ url('klasy/dodaj') }}">Dodaj zajęcia</a></li>
        </ul>
        </div>
    </div>
    </div>
...
<div class="content--main">
    ...
    <div class="col-xl-12">
        ...
        <div class="row">
            ...
            @endif
            <form method="POST" action="{{ url('rozklad/dodaj/'.$schoolroom->schoolroom_id.'/'.$active_week) }}" >
            @csrf
                ...
                <label for="exampleInputEmail1">Dzień</label>
                  ...
                  <div class="form-group">
                    ...
                    <select class="custom-select" name="shedule_week">
                      <option value="A" {{ ($active_week == 'A') ? 'selected' : '' }}>A</option>
                      <option value="B" {{ ($active_week == 'B') ? 'selected' : '' }}>B</option>
                    </select>
                  </div>
