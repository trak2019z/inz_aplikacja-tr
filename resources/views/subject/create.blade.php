...
<div class="content--title">
    ...
    <div class="col-xl-6">
        ...
        <ul class="content--title--right--breadcrumb">
            ...
            <li class="active"><a href="{{ url('przedmioty/dodaj') }}">Dodaj przedmiot</a></li>
        </ul>
        </div>
    </div>
    </div>
...
<div class="content--main">
    ...
    <div class="col-xl-12">
        ...
        <div class="row">
            ...
            @endif
            <form method="POST" action="{{ url('przedmioty/dodaj') }}" >
            @csrf
                <div class="form-group">
                <label for="exampleInputEmail1">Nazwa przedmiotu</label>
                <input type="text" class="form-control" name="subject_name">
                </div>
                <button type="submit" class="btn-md btn-primary">Dodaj przedmiot</button>
