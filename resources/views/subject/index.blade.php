...
<div class="content--title">
    ...
    <div class="col-xl-6">
        ...
        <ul class="content--title--right--breadcrumb">
            <li class="active"><a href="{{ url('przedmioty') }}">Przedmioty</a></li>
        </ul>
        </div>
    </div>
    </div>
...
<div class="content--buttons">
    ...
    <div class="col-xl-12">
        ...
        <a href="{{ url('przedmioty/dodaj') }}" class="btn btn-primary btn-md"><i class="icon-plus"></i> Dodaj przedmiot</a>
        </div>
    </div>
    </div>
</div>
    ...
    <div class="col-xl-12">
        ...
        <table>
            ...
            <tr>
                ...
                <td class="action">
                <a href="{{ url('przedmioty/edytuj/'.$subject->subject_id ) }}"><i class="icon-pencil"></i></a>
                <a href="javascript:;" class="remove-record" data-toggle="modal" data-target="#exampleModalCenter" data-url="{{ url('przedmioty/usun/'.$subject->subject_id )}}" data-id="{{ $subject->subject_id }}" data-name="{{ $subject->subject_name }}"><i class="icon-trash"></i></a>
                </td>
            </tr>
            @endforeach
            </tbody>
