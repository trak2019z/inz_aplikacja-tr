...
<div class="content--title">
    ...
    <div class="col-xl-6">
        ...
        <h4>Edytyj {{ $teacher->teacher_name }}</h4>
        </div>
    </div>
    ...
    <div class="col-xl-6">
        ...
        <ul class="content--title--right--breadcrumb">
            ...
            <li class="active"><a href="{{ url('nauczyciele/edytuj/'.$teacher->teacher_id) }}">Edycja nauczyciela</a></li>
        </ul>
        </div>
    </div>
    </div>
...
<div class="content--main">
    ...
    <div class="col-xl-12">
        ...
        <div class="row">
            ...
            @endif
            <form method="POST" action="{{ url('nauczyciele/edytuj/'.$teacher->teacher_id) }}" >
            @csrf
