...
<script src="<?php echo e(asset('public/node_modules/shedule/js/modernizr.js')); ?>"></script>
<script src="<?php echo e(asset('public/node_modules/shedule/js/main.js')); ?>"></script>
</body>
</html>
