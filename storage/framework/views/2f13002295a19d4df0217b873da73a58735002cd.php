...
<div class="content--title">
    ...
    <div class="col-xl-6">
        ...
        <ul class="content--title--right--breadcrumb">
            <li class="active"><a href="<?php echo e(url('nauczyciele')); ?>">Nauczyciele</a></li>
        </ul>
        </div>
    </div>
    </div>
...
<div class="content--buttons">
    ...
    <div class="col-xl-12">
        ...
        <a href="<?php echo e(url('nauczyciele/dodaj')); ?>" class="btn btn-primary btn-md"><i class="icon-plus"></i> Dodaj nauczyciela</a>
        </div>
    </div>
    </div>
</div>
    ...
    <div class="col-xl-12">
        ...
        <table>
            ...
            <tr>
                ...
                <td class="action">
                <a href="<?php echo e(url('nauczyciele/edytuj/'.$teacher->teacher_id )); ?>"><i class="icon-pencil"></i></a>
                <a href="javascript:;" class="remove-record" data-toggle="modal" data-target="#exampleModalCenter" data-url="<?php echo e(url('nauczyciele/usun/'.$teacher->teacher_id )); ?>" data-id="<?php echo e($teacher->teacher_id); ?>" data-name="<?php echo e($teacher->teacher_name); ?>"><i class="icon-trash"></i></a>
                </td>
            </tr>
